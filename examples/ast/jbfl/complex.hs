                ...
                { rsBySelectors = fromList [], rsPrefixes = [], rsAnyObjectKey = Just
                  ( RuleSet
                    { rsBySelectors = fromList [], rsPrefixes = [], rsAnyObjectKey = Nothing, rsAnyArrayIndex = Nothing, rsHere = fromList
                      [
                        ( SomeKey PreserveNumberFormat, SomeProperty PreserveNumberFormat True ) ], rsBelow = fromList
                      [
                        ( SomeKey ComplexNewLine, SomeProperty ComplexNewLine None ) ] } ), rsAnyArrayIndex = Just
                  ( RuleSet
                    { rsBySelectors = fromList [], rsPrefixes = [], rsAnyObjectKey = Just
                      ( RuleSet
                        { rsBySelectors = fromList [], rsPrefixes = [], rsAnyObjectKey = Nothing, rsAnyArrayIndex = Nothing, rsHere = fromList
                          [
                            ( SomeKey PreserveNumberFormat, SomeProperty PreserveNumberFormat True ) ], rsBelow = fromList
                          [
                            ( SomeKey ComplexNewLine, SomeProperty ComplexNewLine None ) ] } ), rsAnyArrayIndex = Nothing, rsHere = fromList [], rsBelow = fromList [] } ), rsHere = fromList
                  [
                    ( SomeKey PreserveNumberFormat, SomeProperty PreserveNumberFormat True ) ], rsBelow = fromList
                  [
                          ...
                          ( RuleSet
                            { rsBySelectors = fromList [], rsPrefixes = [], rsAnyObjectKey = Nothing, rsAnyArrayIndex = Nothing, rsHere = fromList
                              [
                                ( SomeKey PreserveNumberFormat, SomeProperty PreserveNumberFormat True ) ], rsBelow = fromList
                              [
                                ( SomeKey ComplexNewLine, SomeProperty ComplexNewLine None ) ] } ), rsHere = fromList [], rsBelow = fromList [] } ) ], rsPrefixes = [], rsAnyObjectKey = Nothing, rsAnyArrayIndex = Nothing, rsHere = fromList [], rsBelow = fromList [] } ) ], rsPrefixes = [], rsAnyObjectKey = Nothing, rsAnyArrayIndex = Nothing, rsHere = fromList [], rsBelow = fromList [] } ),
              ...
              ( RuleSet
                { rsBySelectors = fromList [], rsPrefixes = [], rsAnyObjectKey = Nothing, rsAnyArrayIndex = Nothing, rsHere = fromList
                  [
                    ( SomeKey PreserveNumberFormat, SomeProperty PreserveNumberFormat True ) ], rsBelow = fromList
                  [
                    ( SomeKey ComplexNewLine, SomeProperty ComplexNewLine None ) ] } ), rsHere = fromList [], rsBelow = fromList [] } ),
                ...
                { rsBySelectors = fromList
                  [
                    ...
                    ( ObjectKey "on", RuleSet
                      { rsBySelectors = fromList [], rsPrefixes = [], rsAnyObjectKey = Nothing, rsAnyArrayIndex = Nothing, rsHere = fromList [], rsBelow = fromList
                        [
                          ( SomeKey PadAmount, SomeProperty PadAmount 10 ) ] } ) ], rsPrefixes = [], rsAnyObjectKey = Nothing, rsAnyArrayIndex = Nothing, rsHere = fromList
                  [
                    ( SomeKey PreserveNumberFormat, SomeProperty PreserveNumberFormat True ) ], rsBelow = fromList
                  [
                    ( SomeKey ComplexNewLine, SomeProperty ComplexNewLine None ) ] } ), rsAnyArrayIndex = Nothing, rsHere = fromList
              [
                ( SomeKey AlignObjectKeys, SomeProperty AlignObjectKeys True ),
                    ...
                    ( RuleSet
                      { rsBySelectors = fromList [], rsPrefixes = [], rsAnyObjectKey = Nothing, rsAnyArrayIndex = Nothing, rsHere = fromList
                        [
                          ( SomeKey PreserveNumberFormat, SomeProperty PreserveNumberFormat True ) ], rsBelow = fromList
                        [
                          ( SomeKey ComplexNewLine, SomeProperty ComplexNewLine None ) ] } ), rsHere = fromList [], rsBelow = fromList [] } ) ], rsPrefixes = [], rsAnyObjectKey = Nothing, rsAnyArrayIndex = Nothing, rsHere = fromList
              [
                ( SomeKey AlignObjectKeys, SomeProperty AlignObjectKeys True ),
                ( SomeKey PreserveNumberFormat, SomeProperty PreserveNumberFormat True ) ], rsBelow = fromList
              [
                      ...
                      ( RuleSet
                        { rsBySelectors = fromList [], rsPrefixes = [], rsAnyObjectKey = Nothing, rsAnyArrayIndex = Nothing, rsHere = fromList
                          ...
                          [
                            ( SomeKey ComplexNewLine, SomeProperty ComplexNewLine None ) ] } ), rsAnyArrayIndex = Nothing, rsHere = fromList
                      [
                        ( SomeKey PadDecimals, SomeProperty PadDecimals 3 ) ], rsBelow = fromList [] } ), rsHere = fromList [], rsBelow = fromList
                  [
                    ( SomeKey ComplexNewLine, SomeProperty ComplexNewLine None ) ] } ), rsHere = fromList
              [
                ( SomeKey AlignObjectKeys, SomeProperty AlignObjectKeys True ),
              ...
              ( RuleSet
                { rsBySelectors = fromList [], rsPrefixes = [], rsAnyObjectKey = Nothing, rsAnyArrayIndex = Nothing, rsHere = fromList
                  [
                    ( SomeKey PreserveNumberFormat, SomeProperty PreserveNumberFormat True ) ], rsBelow = fromList
                  [
                    ( SomeKey ComplexNewLine, SomeProperty ComplexNewLine None ) ] } ), rsAnyArrayIndex = Nothing, rsHere = fromList [], rsBelow = fromList [] } ),
              ...
              ( RuleSet
                { rsBySelectors = fromList [], rsPrefixes = [], rsAnyObjectKey = Nothing, rsAnyArrayIndex = Nothing, rsHere = fromList
                  [
                    ( SomeKey PreserveNumberFormat, SomeProperty PreserveNumberFormat True ) ], rsBelow = fromList
                  [
                    ( SomeKey ComplexNewLine, SomeProperty ComplexNewLine None ) ] } ), rsHere = fromList [], rsBelow = fromList [] } ) ], rsPrefixes = [], rsAnyObjectKey = Nothing, rsAnyArrayIndex = Nothing, rsHere = fromList [], rsBelow = fromList
        [
